# Brewery Case Study - CIP at change of recipe, Modified Implementation
# MILP Script
# Author: Andreas Juhl Sørensen
# 2024

#The only difference to CS2_RecipesCIPini.py is setting the storage capacity 
# for Hot Mash (HM) to zero
